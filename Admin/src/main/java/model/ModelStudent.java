...
public class ModelStudent {
    ...
    private int year;
    private String departement="no";
    private double jpa=-1;

    public ModelStudent(){}

    public ModelStudent(int id, String username, String name, String address, int year, String departement, float jpa) {
        this.id = id;
